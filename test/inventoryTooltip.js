...
assert(indexSource.includes("css/overlay.css?v=1.7.4"), "Overlay CSS cache bust should include the tooltip refresh.");
assert(indexSource.includes("client.js?v=1.7.4"), "Client cache bust should include the tooltip refresh.");
