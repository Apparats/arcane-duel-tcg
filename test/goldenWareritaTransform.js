...
const warerita = getCardById("base:warerita");
assert(game.players[0].board[1].attack === warerita.attack && game.players[0].board[1].health === warerita.health, "The replacement must use normal Warerita stats.");
