...
assert(card.abilities.some((ability) => ability.effect === "buffSelf" && ability.attack === 3 && ability.health === 3), "High_Inquisitor_KnkL should buff only itself.");
assert(card.lore.includes("+3/+3"), "High_Inquisitor_KnkL should describe its self-buff.");
