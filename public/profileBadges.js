...
(function () {
  const ART = {
    ...
    "ranking-elite": '<path d="M16 49h32"/><path d="M20 49V32h8v17M30 49V22h8v27M40 49V14h8v35"/><path d="m20 26 8-7 7 5 12-12"/><path d="m43 12h4v4"/>',
    "ranking-apex": '<path d="m32 9 7 14 15 2-11 11 3 15-14-7-14 7 3-15-11-11 15-2z"/><path d="M32 21v18M26 27l6-6 6 6"/><path d="M25 51h14"/>',
    "base-archivist": '<path d="M18 14h24c4 0 7 3 7 7v29H25c-4 0-7-3-7-7z"/><path d="M25 14v29c0 4 3 7 7 7M25 23h16M25 31h16M25 39h10"/><path d="m44 17 4-5 4 5"/>',
    "expansion-one-archivist": '<path d="M16 17h32v30H16z"/><path d="m16 17 16 11 16-11M32 28v19"/><path d="M26 11h12M32 11v8"/><path d="M24 53h16"/>',
  ...
  const PALETTES = {
    ...
    "ranking-elite": ["#a7f3d0", "#2f8f8a"],
    "ranking-apex": ["#ffe28a", "#d64a42"],
    "base-archivist": ["#f3ca75", "#5a8fd8"],
    "expansion-one-archivist": ["#8fe8ff", "#7656d8"],
